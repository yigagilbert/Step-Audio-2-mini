...
CHECKS = [
    ...
    ModuleCheck("SciPy", "scipy", "scipy>=1.11.0", ("advanced",)),
    ModuleCheck(
        "SONAR",
        "sonar",
        "sonar-space~=0.5.0",
        ("advanced",),
        "Needed for BLASER 2.0.",
    ),
    ModuleCheck(
        "fairseq2",
        "fairseq2",
        "fairseq2",
        ("advanced",),
        "Install from the CUDA/PyTorch-specific index.",
    ),
...
PROFILE_GROUPS = {
    ...
    "all": {"core", "text_eval", "stepaudio_tts", "cascade_tts", "advanced"},
}
