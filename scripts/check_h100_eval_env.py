...
CHECKS = [
    ...
    ModuleCheck("NumPy", "numpy", "numpy>=1.26.4", ("core", "blaser")),
    ...
    ModuleCheck(
        ...
        "torch==2.6.0",
        ("blaser",),
        "Expected torch 2.6.x/cu124 for fairseq2 0.6.",
    ),
    ModuleCheck(
        "TorchAudio (BLASER)",
        "torchaudio",
        "torchaudio==2.6.0",
        ("blaser",),
        "Expected torchaudio 2.6.x/cu124 for fairseq2 0.6.",
    ),
    ModuleCheck("Transformers", "transformers", "transformers==4.49.0", ("core", "blaser")),
    ModuleCheck("Datasets", "datasets", "datasets[audio]>=2.21.0", ("core",)),
    ModuleCheck("PEFT", "peft", "peft>=0.12.0", ("core",)),
    ModuleCheck("SacreBLEU", "sacrebleu", "sacrebleu>=2.4.3", ("core", "blaser")),
    ModuleCheck("JiWER", "jiwer", "jiwer>=3.0.4", ("core",)),
    ModuleCheck("tqdm", "tqdm", "tqdm>=4.66.5", ("core", "blaser")),
    ModuleCheck("Librosa", "librosa", "librosa>=0.10.2.post1", ("core", "blaser")),
    ModuleCheck("SoundFile", "soundfile", "soundfile>=0.12.1", ("core", "blaser")),
    ...
    ModuleCheck("SciPy", "scipy", "scipy>=1.11.0", ("audio_metrics", "blaser")),
    ModuleCheck(
        "SONAR",
        "sonar",
        "sonar-space~=0.5.0",
